  ...
  return (
    <>
      <Helmet>
        ...
        <title>Lunar Animes</title>
        <meta
          name="description"
          content="Dive into a world of anime with German dub, sub, or enjoy the best of both with English options!"
        />
        <link rel="manifest" href="/manifest.json" />
        <meta property="og:title" content="AD-Free Streaming Platform" />
        <meta property="og:description" content="Dive into a world of anime with German dub, sub, or enjoy the best of both with English options!" />
        <meta property="og:image" content="https://i.imgur.com/Jp9w4wF.png" />
